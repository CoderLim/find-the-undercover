<div align="center">
  ...
  <a href="assets/miniprogram-qrcode.png">
    <img src="assets/miniprogram-qrcode.png" alt="谁是卧底·拼音版 微信小程序二维码" width="220" />
  </a>

  <p><sub><strong>📱 微信扫一扫，立即开玩</strong>（无需下载、无需注册、3~12 人围坐就能开局）</sub></p>
</div>
...
打开微信 → **扫一扫** → 对准上方二维码，即可进入「谁是卧底·拼音版」小程序。
也可以在微信内直接搜索小程序名「**谁是卧底·拼音版**」找到我们。

> 小程序完全本地运行，所有词库都打包在客户端，**无任何联网请求 / 无广告 / 无登录**，保护小朋友的注意力 🌱。
...
│   └── miniprogram-qrcode.png       上线后的小程序码，方便分享朋友圈
├── scripts/
